...
import (
	...
	"github.com/cdktf/cdktf-provider-opc-go/opc/v3/lbaasloadbalancer/internal"
...
func (j *jsiiProxy_LbaasLoadBalancer) Count() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"count",
...
func (j *jsiiProxy_LbaasLoadBalancer)SetCount(val *float64) {
	_jsii_.Set(
		j,
		"count",
		val,
