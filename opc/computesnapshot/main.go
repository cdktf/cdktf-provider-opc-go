...
func init() {
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-opc.computeSnapshot.ComputeSnapshotConfig",
		reflect.TypeOf((*ComputeSnapshotConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktf/provider-opc.computeSnapshot.ComputeSnapshotTimeouts",
		reflect.TypeOf((*ComputeSnapshotTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-opc.computeSnapshot.ComputeSnapshotTimeoutsOutputReference",
