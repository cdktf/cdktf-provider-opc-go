...
func init() {
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-opc.computeInstance.ComputeInstanceConfig",
		reflect.TypeOf((*ComputeInstanceConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktf/provider-opc.computeInstance.ComputeInstanceNetworkingInfo",
		reflect.TypeOf((*ComputeInstanceNetworkingInfo)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-opc.computeInstance.ComputeInstanceNetworkingInfoList",
		reflect.TypeOf((*ComputeInstanceNetworkingInfoList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*ComputeInstanceNetworkingInfoOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-opc.computeInstance.ComputeInstanceStorage",
		reflect.TypeOf((*ComputeInstanceStorage)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-opc.computeInstance.ComputeInstanceStorageList",
		reflect.TypeOf((*ComputeInstanceStorageList)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
			_jsii_.MemberProperty{JsiiProperty: "creationStack", GoGetter: "CreationStack"},
			_jsii_.MemberProperty{JsiiProperty: "fqn", GoGetter: "Fqn"},
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*ComputeInstanceStorageOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIndex", GoGetter: "ComplexObjectIndex"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIsFromSet", GoGetter: "ComplexObjectIsFromSet"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-opc.computeInstance.ComputeInstanceTimeouts",
