...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*ComputeMachineImage)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-opc.computeMachineImage.ComputeMachineImageConfig",
		reflect.TypeOf((*ComputeMachineImageConfig)(nil)).Elem(),
	)
}
