...
func ComputeStorageVolumeSnapshot_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateComputeStorageVolumeSnapshot_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (c *jsiiProxy_ComputeStorageVolumeSnapshot) AddMoveTarget(moveTarget *string) {
...
func (c *jsiiProxy_ComputeStorageVolumeSnapshot) HasResourceMove() interface{} {
	var returns interface{}
...
func (c *jsiiProxy_ComputeStorageVolumeSnapshot) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (c *jsiiProxy_ComputeStorageVolumeSnapshot) MoveFromId(id *string) {
...
func (c *jsiiProxy_ComputeStorageVolumeSnapshot) MoveTo(moveTarget *string, index interface{}) {
...
func (c *jsiiProxy_ComputeStorageVolumeSnapshot) MoveToId(id *string) {
...
func (c *jsiiProxy_ComputeStorageVolumeSnapshot) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (c *jsiiProxy_ComputeStorageVolumeSnapshot) ToHclTerraform() interface{} {
	var returns interface{}
