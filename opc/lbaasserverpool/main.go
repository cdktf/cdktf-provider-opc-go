...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*LbaasServerPool)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "resetVnicSet", GoMethod: "ResetVnicSet"},
			...
			_jsii_.MemberProperty{JsiiProperty: "vnicSet", GoGetter: "VnicSet"},
			_jsii_.MemberProperty{JsiiProperty: "vnicSetInput", GoGetter: "VnicSetInput"},
		},
		func() interface{} {
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-opc.lbaasServerPool.LbaasServerPoolConfig",
		reflect.TypeOf((*LbaasServerPoolConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktf/provider-opc.lbaasServerPool.LbaasServerPoolHealthCheck",
		reflect.TypeOf((*LbaasServerPoolHealthCheck)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-opc.lbaasServerPool.LbaasServerPoolHealthCheckOutputReference",
		reflect.TypeOf((*LbaasServerPoolHealthCheckOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "acceptedReturnCodes", GoGetter: "AcceptedReturnCodes"},
			_jsii_.MemberProperty{JsiiProperty: "acceptedReturnCodesInput", GoGetter: "AcceptedReturnCodesInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetAcceptedReturnCodes", GoMethod: "ResetAcceptedReturnCodes"},
			_jsii_.MemberMethod{JsiiMethod: "resetEnabled", GoMethod: "ResetEnabled"},
