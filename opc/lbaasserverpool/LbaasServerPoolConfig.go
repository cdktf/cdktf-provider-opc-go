...
type LbaasServerPoolConfig struct {
	// Experimental.
	...
	HealthCheck *LbaasServerPoolHealthCheck `field:"optional" json:"healthCheck" yaml:"healthCheck"`
	...
	VnicSet *string `field:"optional" json:"vnicSet" yaml:"vnicSet"`
}
