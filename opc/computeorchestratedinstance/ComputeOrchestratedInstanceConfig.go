...
type ComputeOrchestratedInstanceConfig struct {
	// Experimental.
	...
	Instance interface{} `field:"required" json:"instance" yaml:"instance"`
	...
	Timeouts *ComputeOrchestratedInstanceTimeouts `field:"optional" json:"timeouts" yaml:"timeouts"`
}
