...
import (
	...
	"github.com/cdktf/cdktf-provider-opc-go/opc/v2/computesecurityrule/internal"
...
func (j *jsiiProxy_ComputeSecurityRule) Count() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"count",
...
func (j *jsiiProxy_ComputeSecurityRule)SetCount(val *float64) {
	_jsii_.Set(
		j,
		"count",
		val,
