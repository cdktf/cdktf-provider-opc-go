...
import (
	...
	"github.com/cdktf/cdktf-provider-opc-go/opc/v8/computesecurityrule/internal"
...
func ComputeSecurityRule_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateComputeSecurityRule_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (c *jsiiProxy_ComputeSecurityRule) AddMoveTarget(moveTarget *string) {
...
func (c *jsiiProxy_ComputeSecurityRule) HasResourceMove() interface{} {
	var returns interface{}
...
func (c *jsiiProxy_ComputeSecurityRule) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (c *jsiiProxy_ComputeSecurityRule) MoveFromId(id *string) {
...
func (c *jsiiProxy_ComputeSecurityRule) MoveTo(moveTarget *string, index interface{}) {
...
func (c *jsiiProxy_ComputeSecurityRule) MoveToId(id *string) {
...
func (c *jsiiProxy_ComputeSecurityRule) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (c *jsiiProxy_ComputeSecurityRule) ToHclTerraform() interface{} {
	var returns interface{}
