...
import (
	...
	"github.com/cdktf/cdktf-provider-opc-go/opc/v7/computeroute/internal"
...
type ComputeRoute interface {
	...
	SetNextHopVnicSet(val *string)
	NextHopVnicSetInput() *string
	// The tree node.
...
func (j *jsiiProxy_ComputeRoute) AdminDistance() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"adminDistance",
...
func (j *jsiiProxy_ComputeRoute) AdminDistanceInput() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"adminDistanceInput",
...
func (j *jsiiProxy_ComputeRoute) IpAddressPrefix() *string {
	var returns *string
	_jsii_.Get(
		j,
		"ipAddressPrefix",
...
func (j *jsiiProxy_ComputeRoute) IpAddressPrefixInput() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_ComputeRoute) NextHopVnicSet() *string {
	var returns *string
	_jsii_.Get(
		j,
		"nextHopVnicSet",
...
func (j *jsiiProxy_ComputeRoute) NextHopVnicSetInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"nextHopVnicSetInput",
...
func NewComputeRoute(scope constructs.Construct, id *string, config *ComputeRouteConfig) ComputeRoute {
	...
	_jsii_.Create(
		"@cdktf/provider-opc.computeRoute.ComputeRoute",
...
func (j *jsiiProxy_ComputeRoute)SetAdminDistance(val *float64) {
...
func (j *jsiiProxy_ComputeRoute)SetIpAddressPrefix(val *string) {
...
func (j *jsiiProxy_ComputeRoute)SetNextHopVnicSet(val *string) {
	if err := j.validateSetNextHopVnicSetParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (c *jsiiProxy_ComputeRoute) ResetAdminDistance() {
	_jsii_.InvokeVoid(
		c,
		"resetAdminDistance",
		nil, // no parameters
