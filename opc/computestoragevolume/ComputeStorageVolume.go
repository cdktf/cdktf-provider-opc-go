...
func (j *jsiiProxy_ComputeStorageVolume) Count() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"count",
...
func (j *jsiiProxy_ComputeStorageVolume)SetCount(val interface{}) {
...
func ComputeStorageVolume_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateComputeStorageVolume_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (c *jsiiProxy_ComputeStorageVolume) AddMoveTarget(moveTarget *string) {
...
func (c *jsiiProxy_ComputeStorageVolume) HasResourceMove() interface{} {
	var returns interface{}
...
func (c *jsiiProxy_ComputeStorageVolume) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (c *jsiiProxy_ComputeStorageVolume) MoveFromId(id *string) {
...
func (c *jsiiProxy_ComputeStorageVolume) MoveTo(moveTarget *string, index interface{}) {
...
func (c *jsiiProxy_ComputeStorageVolume) MoveToId(id *string) {
...
func (c *jsiiProxy_ComputeStorageVolume) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (c *jsiiProxy_ComputeStorageVolume) ToHclTerraform() interface{} {
	var returns interface{}
