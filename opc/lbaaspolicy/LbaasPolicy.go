...
func (l *jsiiProxy_LbaasPolicy) HasResourceMove() interface{} {
	var returns interface{}
...
func (l *jsiiProxy_LbaasPolicy) MoveFromId(id *string) {
...
func (l *jsiiProxy_LbaasPolicy) MoveToId(id *string) {
...
func (l *jsiiProxy_LbaasPolicy) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (l *jsiiProxy_LbaasPolicy) ToHclTerraform() interface{} {
	var returns interface{}
