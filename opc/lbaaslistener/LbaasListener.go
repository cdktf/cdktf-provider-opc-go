...
import (
	...
	"github.com/cdktf/cdktf-provider-opc-go/opc/v8/lbaaslistener/internal"
...
func (j *jsiiProxy_LbaasListener) Count() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"count",
...
func (j *jsiiProxy_LbaasListener)SetCount(val interface{}) {
...
func LbaasListener_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateLbaasListener_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (l *jsiiProxy_LbaasListener) AddMoveTarget(moveTarget *string) {
...
func (l *jsiiProxy_LbaasListener) HasResourceMove() interface{} {
	var returns interface{}
...
func (l *jsiiProxy_LbaasListener) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (l *jsiiProxy_LbaasListener) MoveFromId(id *string) {
...
func (l *jsiiProxy_LbaasListener) MoveTo(moveTarget *string, index interface{}) {
...
func (l *jsiiProxy_LbaasListener) MoveToId(id *string) {
...
func (l *jsiiProxy_LbaasListener) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (l *jsiiProxy_LbaasListener) ToHclTerraform() interface{} {
	var returns interface{}
