...
func ComputeVpnEndpointV2_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateComputeVpnEndpointV2_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (c *jsiiProxy_ComputeVpnEndpointV2) AddMoveTarget(moveTarget *string) {
...
func (c *jsiiProxy_ComputeVpnEndpointV2) HasResourceMove() interface{} {
	var returns interface{}
...
func (c *jsiiProxy_ComputeVpnEndpointV2) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (c *jsiiProxy_ComputeVpnEndpointV2) MoveFromId(id *string) {
...
func (c *jsiiProxy_ComputeVpnEndpointV2) MoveTo(moveTarget *string, index interface{}) {
...
func (c *jsiiProxy_ComputeVpnEndpointV2) MoveToId(id *string) {
...
func (c *jsiiProxy_ComputeVpnEndpointV2) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (c *jsiiProxy_ComputeVpnEndpointV2) ToHclTerraform() interface{} {
	var returns interface{}
