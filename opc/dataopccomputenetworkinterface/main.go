...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataOpcComputeNetworkInterface)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-opc.dataOpcComputeNetworkInterface.DataOpcComputeNetworkInterfaceConfig",
		reflect.TypeOf((*DataOpcComputeNetworkInterfaceConfig)(nil)).Elem(),
	)
}
