...
import (
	...
	"github.com/cdktf/cdktf-provider-opc-go/opc/v8/dataopccomputestoragevolumesnapshot/internal"
...
func DataOpcComputeStorageVolumeSnapshot_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateDataOpcComputeStorageVolumeSnapshot_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (d *jsiiProxy_DataOpcComputeStorageVolumeSnapshot) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (d *jsiiProxy_DataOpcComputeStorageVolumeSnapshot) ToHclTerraform() interface{} {
	var returns interface{}
