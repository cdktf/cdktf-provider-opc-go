...
import (
	...
	"github.com/cdktf/cdktf-provider-opc-go/opc/v3/dataopccomputestoragevolumesnapshot/internal"
...
func (j *jsiiProxy_DataOpcComputeStorageVolumeSnapshot) Count() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"count",
...
func (j *jsiiProxy_DataOpcComputeStorageVolumeSnapshot)SetCount(val *float64) {
	_jsii_.Set(
		j,
		"count",
		val,
